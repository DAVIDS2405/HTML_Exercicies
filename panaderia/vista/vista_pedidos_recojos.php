  ...
  <head>
    ...
    <script>
        $(document).ready(function(){        
            ...
            $(document).on("click",".recoger-btn",function(){
                if (confirm("¿Estás seguro de recoger?")) {
                    var id = $(this).data('id');
                    
                    $.ajax({
                        url :"../controlador/controlador_recojo.php",
                        type:"GET",
                        cache:false,
                        data:{opcion:11,recogerId:id},
            ...
            <?php
                //La estructura foreach trabaja con colecciones o arreglos
                    foreach($RegistrosRecojos as $reg){
                        ...
                        echo '<td style="text-align:center"><a href="../controlador/controlador_recojo.php?opcion=11&id='.$reg['id_ped'].'" class="btn btn-success btn-sm">Recoger</a></td>';
